 ...
 */
class DefaultEglCore constructor(
    ...
    override fun createPbufferSurface(width: Int, height: Int) {
    ...
    override fun createWindowSurface(surface: Any): EGLSurface? {
        ...
        DefaultEglCore.checkGlError("eglCreateWindowSurface")
        if (eglSurface == null) {
    ...
    override fun createOffscreenSurface(width: Int, height: Int): EGLSurface? {
        ...
        DefaultEglCore.checkGlError("eglCreatePbufferSurface")
        if (eglSurface == null) {
            throw java.lang.RuntimeException("surface was null")
        }
        return eglSurface
    ...
    override fun surfaceHeight(): Int {
